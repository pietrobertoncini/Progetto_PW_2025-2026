...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    try {
        // Verifica della corrispondenza dei dati nel database e validazione della password
        $utente_trovato = controllaUtente($cid, $email, $password);

        if ($utente_trovato) {
            // Memorizzazione dei dati identificativi e del ruolo all'interno della sessione di lavoro
