...
function promuoviAResponsabile($cid, $id_utente, $id_settore) {
    ...
    try {
        $cid->query("UPDATE SETTORE SET id_responsabile = NULL WHERE id_settore = $id_settore"); // Reset vecchio resp
...
/* -------------------------------------------------------------------------- */
/* FUNZIONI PER RESPONSABILE                          */
/* -------------------------------------------------------------------------- */

// 1. Recupera la lista delle sale di un settore
...
// 2. Recupera le dotazioni di una specifica sala (Stringa separata da virgola)
...
// 3. Recupera le prenotazioni fatte dall'organizzatore (Responsabile)
...
// 4. Recupera le risposte agli inviti inviati dal responsabile
