...
<body class="d-flex flex-column h-100">
    ...
    <div class="flex-shrink-0 container py-5">
        ...
        <div class="d-flex justify-content-between align-items-center mb-3 flex-wrap gap-3">
            <h2 class="m-0 text-nowrap">Gestione Prenotazioni</h2>

            <div class="card shadow-sm border-0 rounded-4 bg-light">
                <div class="card-body p-2">
                    <form method="GET" action="<?php echo BASE_URL; ?>frontend/admin_prenotazioni.php" class="d-flex align-items-center gap-2">
                        <input type="hidden" name="week" value="<?php echo $lunedi_settimana; ?>">

                        <label class="fw-bold text-muted m-0 text-nowrap"><i class="bi bi-funnel-fill"></i> Filtra per Sala:</label>

                        <select name="sala" id="sala" class="form-select form-select-sm rounded-pill border-secondary">
                            <option value="" <?php echo !$filtro_sala ? 'selected' : ''; ?>>-- Mostra Tutte (Lista Globale) --</option>
