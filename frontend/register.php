            ...
            <div class="col-md-8 col-lg-7">
                <div class="card shadow-sm rounded-4">
                    <div class="card-body p-4 p-md-5">
                        ...
                        <form action="<?php echo BASE_URL; ?>backend/register_exe.php" method="POST" enctype="multipart/form-data" id="registerForm">
                            <div class="row">
                            ...
                            <div class="mb-3">
                                ...
                                <span id="errPassword" class="text-danger small text-danger-custom"></span>
                            </div>
                            <div class="mb-3">
